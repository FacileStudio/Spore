				...
				<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
					<div class="grid grid-cols-1 md:grid-cols-4 gap-8">
						...
						<div class="space-y-4">
							...
							<div class="flex space-x-4">
								<a href="https://github.com/saravenpi/spore" class="text-gray-400 hover:text-white transition-colors" aria-label="GitHub">
								...
								<a href="https://twitter.com/sporespace" class="text-gray-400 hover:text-white transition-colors" aria-label="Twitter">
									<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
					...
					<div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
						...
						<div class="flex items-center space-x-6 text-sm">
							...
							<a href="https://github.com/saravenpi/spore" class="text-gray-400 hover:text-white transition-colors">GitHub</a>
						</div>
					</div>
				</div>
			</footer>
