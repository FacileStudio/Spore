...
<svelte:head>
	<title>Project Structure - Spore CLI Documentation</title>
...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6">
	<div class="mb-8">
		...
		<p class="text-lg text-muted-foreground">
			Understanding how Spore organizes monorepo projects and their components
		</p>
	</div>
	...
	<section class="mb-12">
		...
		<p class="text-muted-foreground leading-relaxed mb-6">
			Spore follows a structured approach to organizing monorepos, making it easy to manage multiple packages 
...
└── <span class="text-gray-400">install.sh</span>                  # Installation script</code></pre>
	...
	<!-- Root Configuration -->
	<section class="mb-12">
		<h2 class="text-2xl font-bold mb-6">Root Configuration (spore.yml)</h2>
...
<span class="text-blue-400">tags:</span>
  ...
  - <span class="text-yellow-400">typescript</span></code>
			...
			<div>
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					...
					<div class="border rounded-lg p-6">
						...
						<p class="text-sm text-muted-foreground mb-3">
							Common utility functions and helpers used across Spore applications.
						</p>
						<div class="text-xs font-mono bg-muted p-2 rounded">
							packages/utils/
						</div>
	...
	<section class="mb-12">
		...
		<div class="space-y-6">
			<p class="text-muted-foreground">
				The <code>apps/</code> directory contains three main applications that make up the Spore ecosystem:
			</p>
			...
			<div>
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
					<div class="border rounded-lg p-6">
						...
						<p class="text-sm text-muted-foreground mb-3">
							The core Spore CLI tool built with Rust for high performance monorepo management.
						</p>
						<div class="text-xs font-mono bg-muted p-2 rounded">
							apps/cli/
						</div>
...
<span class="text-blue-400">scripts:</span>
  ...
  <span class="text-blue-400">clean:</span> <span class="text-green-400">"rm -rf .svelte-kit build node_modules"</span>`}</code></pre>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
			<div class="space-y-6">
				...
				<div class="border rounded-lg p-6">
					...
					<div class="text-sm font-mono bg-muted p-3 rounded">
						...
						├── package.json<br>
						├── tsconfig.json<br>
						├── spore_packages/  # Auto-generated<br>
						├── src/<br>
						├── public/<br>
						└── dist/
					</div>
			...
			<div class="space-y-6">
				...
				<div class="border rounded-lg p-6">
					...
					<ul class="text-sm text-muted-foreground space-y-2">
						<li>• Don't modify spore_packages/ manually</li>
						<li>• Avoid circular dependencies between packages</li>
						<li>• Don't commit spore_packages/ to version control</li>
	...
	<section class="mb-12">
		...
		<div class="space-y-6">
			<p class="text-muted-foreground">
				Spore automatically configures TypeScript path mapping to make package imports clean and intuitive.
			</p>
	...
	<section class="mb-12">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
			...
			<a href="/docs/package-linking" class="block border rounded-lg p-6 hover:bg-accent transition-colors">
				...
				<p class="text-sm text-muted-foreground">
					Understand how Spore links packages and the different linking modes available.
				</p>
			</a>
		</div>
	</section>
