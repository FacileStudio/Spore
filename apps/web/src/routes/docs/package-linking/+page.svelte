			...
			<div class="flex items-start space-x-3">
				...
				<div>
					...
					<p class="text-sm text-blue-700">
						By default, Spore copies package contents to <code>spore_packages/</code> directories in your apps. 
			...
			<div>
				...
				<div class="ml-9 space-y-3">
					...
					<div class="bg-black/90 text-white font-mono text-sm p-4 rounded-lg">
						<code><span class="text-gray-400"># From spore.yml or app.yml</span>
    ...
    <span class="text-blue-400">packages:</span>
      ...
      - <span class="text-yellow-400">"@team/shared"</span></code>
			...
			<div>
				...
				<div class="ml-9 space-y-3">
					<p class="text-muted-foreground">
						The <code>spore_packages/</code> directory is created in each app that has package dependencies.
					</p>
					<div class="bg-muted/30 rounded-lg p-4">
						<div class="text-sm font-mono">
							apps/frontend/<br>
							├── spore_packages/  <span class="text-green-600"># Auto-generated</span><br>
							│   ├── types/<br>
							│   ├── utils/<br>
						...
						<pre><code>{@html `<span class="text-gray-400">// tsconfig.json</span>
{
  <span class="text-blue-400">"compilerOptions"</span>: {
    ...
    <span class="text-blue-400">"paths"</span>: {
      ...
      <span class="text-green-400">"@/shared"</span>: [<span class="text-green-400">"./spore_packages/@team_shared"</span>]
    }
  }
}`}</code></pre>
					</div>
		...
		<div class="space-y-6">
			...
			<div>
				...
				<p class="text-muted-foreground mb-4">
					When you run <code>spore link</code>, the system reads your alias configuration and updates TypeScript paths accordingly.
				</p>
				<div class="bg-black/90 text-white font-mono text-sm p-4 rounded-lg">
					<code><span class="text-gray-400"># In spore.yml or app.yml</span>
<span class="text-blue-400">apps:</span>
  <span class="text-blue-400">frontend:</span>
...
{"{"}
  <span class="text-blue-400">"compilerOptions"</span>: {"{"}
    <span class="text-blue-400">"baseUrl"</span>: <span class="text-green-400">"."</span>,
    <span class="text-blue-400">"paths"</span>: {"{"}
      <span class="text-green-400">"@/ui-components"</span>: [<span class="text-green-400">"./spore_packages/ui-components"</span>],
      <span class="text-green-400">"@/shared-types"</span>: [<span class="text-green-400">"./spore_packages/shared-types"</span>]
    {"}"}
  {"}"}, 
  <span class="text-blue-400">"include"</span>: [<span class="text-green-400">"spore_packages/**/*"</span>]
{"}"}</code></pre>
						</div>
					</div>
				</div>
...
<span class="text-green-400">"@/ui-components"</span> → <span class="text-blue-400">./spore_packages/ui-components</span>
<span class="text-green-400">"@/shared-types"</span> → <span class="text-blue-400">./spore_packages/shared-types</span>
<span class="text-green-400">"@/design-system"</span> → <span class="text-blue-400">./spore_packages/@company_design-system</span></code>
							</div>
						</div>
					</div>
...
<span class="text-blue-400">"paths"</span>: {"{"}
  <span class="text-green-400">"@/*"</span>: [<span class="text-green-400">"./spore_packages/*"</span>]
{"}"}</code>
							</div>
						</div>
					</div>
					...
					<div class="space-y-3">
						<div class="bg-black/90 text-purple-400 font-mono text-sm p-3 rounded relative group">
							...
							<button 
								...
								on:click={() => copyToClipboard('spore link --symlink')}
							>
								{#if showCopied && copyText === 'spore link --symlink'}
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				<div class="border rounded-lg p-6">
					...
					<div class="space-y-3 text-sm">
						...
						<div>
							...
							<div class="text-muted-foreground">Run <code>spore link --force</code> to refresh</div>
						</div>
						<div>
				...
				<div class="border rounded-lg p-6">
					...
					<div class="space-y-3 text-sm">
						...
						<div>
							<div class="font-medium"><code>spore link --dry-run</code></div>
