...
<svelte:head>
	<title>TypeScript & JavaScript - Spore CLI Documentation</title>
	<meta name="description" content="Build and manage TypeScript and JavaScript packages with Spore. Learn about type definitions, builds, and best practices." />
	<meta property="og:title" content="TypeScript & JavaScript - Spore CLI" />
	<meta property="og:description" content="Build and manage TypeScript and JavaScript packages with Spore. Learn about type definitions, builds, and best practices." />
	<meta property="og:url" content="https://spore.klysium.com/docs/typescript" />
	<meta name="twitter:title" content="TypeScript & JavaScript - Spore CLI" />
	<meta name="twitter:description" content="Build and manage TypeScript and JavaScript packages with Spore. Learn about type definitions, builds, and best practices." />
	<link rel="canonical" href="https://spore.klysium.com/docs/typescript" />
</svelte:head>
...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6">
	<div class="mb-8">
		...
		<p class="text-lg text-muted-foreground">
			Build and manage TypeScript and JavaScript packages with Spore.
		</p>
	</div>
	...
	<section class="mb-12">
		...
		<p class="text-muted-foreground mb-6 leading-relaxed">
			Spore provides first-class support for TypeScript and JavaScript packages, including automatic type generation, 
  ...
  <span class="text-green-400">"scripts"</span>: {
    <span class="text-green-400">"build"</span>: <span class="text-yellow-400">"spore build"</span>,
    <span class="text-green-400">"test"</span>: <span class="text-yellow-400">"spore test"</span>,
    <span class="text-green-400">"lint"</span>: <span class="text-yellow-400">"spore lint"</span>,
    <span class="text-green-400">"dev"</span>: <span class="text-yellow-400">"spore dev"</span>
  },
  <span class="text-green-400">"devDependencies"</span>: {
					...
					<div class="flex-1">
						...
						<div class="bg-black/90 text-green-400 font-mono text-sm rounded-lg relative group mb-3">
							<div class="overflow-x-auto p-4 pr-12">
								<code class="whitespace-nowrap block">spore build</code>
							</div>
							<button 
			...
			<div class="bg-green-50 border border-green-200 rounded-lg p-6">
				<div class="flex items-start space-x-3">
					...
					<div class="flex-1">
						...
						<div class="bg-black/90 text-green-400 font-mono text-sm rounded-lg relative group mb-3">
							<div class="overflow-x-auto p-4 pr-12">
								<code class="whitespace-nowrap block">spore dev</code>
							</div>
							<button 
								class="absolute top-2 right-2 p-2 rounded-md bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover:opacity-100 z-10"
								on:click={() => copyToClipboard('spore dev')}
							>
								{#if showCopied && copyText === 'spore dev'}
									<Icon icon="lucide:check-circle" class="w-4 h-4 text-green-400" />
								{:else}
									<Icon icon="lucide:copy" class="w-4 h-4" />
								{/if}
	...
	<section class="mb-12">
		...
		<p class="text-muted-foreground mb-6 leading-relaxed">
			Spore automatically generates and includes TypeScript type definitions when you publish packages. 
...
spore test --coverage`}</code></pre>
				</div>
				<button 
					class="absolute top-2 right-2 p-2 rounded-md bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover:opacity-100 z-10"
					on:click={() => copyToClipboard('spore test')}
				>
					{#if showCopied && copyText === 'spore test'}
						<Icon icon="lucide:check-circle" class="w-4 h-4 text-green-400" />
					{:else}
						<Icon icon="lucide:copy" class="w-4 h-4" />
					{/if}
