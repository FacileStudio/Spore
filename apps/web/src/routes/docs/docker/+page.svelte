...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6">
	<div class="mb-8">
		...
		<p class="text-lg text-muted-foreground">
			Learn how to containerize your Spore monorepo projects and deploy them with Docker
		</p>
	</div>

	<!-- Overview -->
	<section class="mb-12">
		<h2 class="text-2xl font-bold mb-6">Why Docker with Spore?</h2>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
			...
			<div class="border rounded-lg p-6">
				...
				<p class="text-sm text-muted-foreground">
					Spore's copy-first package linking works perfectly with Docker's layered architecture.
				</p>
			</div>
		</div>
			...
			<div class="flex items-start space-x-3">
				...
				<div>
					...
					<p class="text-sm text-amber-700">
						Always use <code>spore link</code> (copy mode) instead of <code>spore link --symlink</code> when building Docker images. 
	...
	<section class="mb-12">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
			<a href="/docs/production" class="block border rounded-lg p-6 hover:bg-accent transition-colors">
				...
				<p class="text-sm text-muted-foreground">
					Learn how to deploy your containerized Spore applications to production environments.
				</p>
			</a>
