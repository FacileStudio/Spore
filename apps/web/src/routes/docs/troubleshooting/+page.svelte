...
<svelte:head>
	<title>Troubleshooting - Spore CLI Documentation</title>
	<meta name="description" content="Common issues and solutions for Spore CLI, package linking, authentication, builds, and publishing. Debug commands and support resources." />
	<meta property="og:title" content="Troubleshooting - Spore CLI" />
	<meta property="og:description" content="Common issues and solutions for Spore CLI, package linking, authentication, builds, and publishing. Debug commands and support resources." />
	<meta property="og:url" content="https://spore.klysium.com/docs/troubleshooting" />
	<meta name="twitter:title" content="Troubleshooting - Spore CLI" />
	<meta name="twitter:description" content="Common issues and solutions for Spore CLI, package linking, authentication, builds, and publishing. Debug commands and support resources." />
	<link rel="canonical" href="https://spore.klysium.com/docs/troubleshooting" />
</svelte:head>
...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6">
	<div class="mb-8">
		...
		<p class="text-lg text-muted-foreground">
			Common issues and solutions for Spore CLI and monorepo management
		</p>
	</div>
		...
		<div class="space-y-6">
				...
				<div class="space-y-3 text-sm">
					...
					<div class="bg-black/90 text-green-400 font-mono text-sm rounded-lg relative group mt-3">
						...
						<button 
							...
							on:click={() => copyToClipboard('spore link --verbose')}
						>
							{#if showCopied && copyText === 'spore link --verbose'}
			...
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					...
					<ul class="space-y-1 ml-4 text-muted-foreground">
						<li>• Verify tsAlias configuration in app.yml or spore.yml</li>
						<li>• Check if tsconfig.json was updated correctly</li>
						<li>• Run <code>spore link --force</code> to refresh all links</li>
						<li>• Restart your IDE/TypeScript service</li>
					</ul>
					<div class="bg-black/90 text-green-400 font-mono text-sm rounded-lg relative group mt-3">
						<div class="overflow-x-auto p-4 pr-12">
							<code class="whitespace-nowrap block">spore link --force</code>
						</div>
						<button 
							class="absolute top-2 right-2 p-2 rounded-md bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover:opacity-100 z-10"
			...
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					...
					<ul class="space-y-1 ml-4 text-muted-foreground">
						...
						<li>• Test with <code>spore auth</code> command</li>
					</ul>
					<div class="bg-black/90 text-green-400 font-mono text-sm rounded-lg relative group mt-3">
						<div class="overflow-x-auto p-4 pr-12">
							<code class="whitespace-nowrap block">spore auth</code>
						</div>
						<button 
							class="absolute top-2 right-2 p-2 rounded-md bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover:opacity-100 z-10"
			...
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					...
					<ul class="space-y-1 ml-4 text-muted-foreground">
						...
						<li>• Verify the SPORE_SPACE_URL is correct</li>
		...
		<div class="space-y-6">
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					...
					<div class="bg-black/90 text-green-400 font-mono text-sm rounded-lg relative group mt-3">
						<div class="overflow-x-auto p-4 pr-12">
							<code class="whitespace-nowrap block">spore run build --verbose</code>
						</div>
						<button 
							class="absolute top-2 right-2 p-2 rounded-md bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover:opacity-100 z-10"
							on:click={() => copyToClipboard('spore run build --verbose')}
						>
							{#if showCopied && copyText === 'spore run build --verbose'}
								<Icon icon="lucide:check-circle" class="w-4 h-4 text-green-400" />
							{:else}
								<Icon icon="lucide:copy" class="w-4 h-4" />
							{/if}
		...
		<div class="space-y-6">
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					...
					<div class="bg-black/90 text-green-400 font-mono text-sm rounded-lg relative group mt-3">
						<div class="overflow-x-auto p-4 pr-12">
							<code class="whitespace-nowrap block">spore publish --dry-run</code>
						</div>
						<button 
							class="absolute top-2 right-2 p-2 rounded-md bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover:opacity-100 z-10"
	...
	<section class="mb-12">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					<div>
						<div class="font-medium"><code>spore status</code></div>
						<div class="text-muted-foreground">Show project and linking status</div>
					</div>
					<div>
						<div class="font-medium"><code>spore --version</code></div>
			...
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					<div>
						<div class="font-medium"><code>spore link --verbose</code></div>
						<div class="text-muted-foreground">Detailed linking output</div>
					</div>
					<div>
						<div class="font-medium"><code>spore publish --verbose</code></div>
						<div class="text-muted-foreground">Detailed publishing output</div>
					</div>
					<div>
						<div class="font-medium"><code>spore run build --verbose</code></div>
		...
		<div class="space-y-6">
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					...
					<ul class="space-y-1 ml-4 text-muted-foreground">
						<li>• Identify the circular path using <code>spore deps tree</code></li>
					...
					<div class="bg-black/90 text-green-400 font-mono text-sm rounded-lg relative group mt-3">
						<div class="overflow-x-auto p-4 pr-12">
							<code class="whitespace-nowrap block">spore deps check --verbose</code>
						</div>
						<button 
							class="absolute top-2 right-2 p-2 rounded-md bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover:opacity-100 z-10"
							on:click={() => copyToClipboard('spore deps check --verbose')}
						>
							{#if showCopied && copyText === 'spore deps check --verbose'}
								<Icon icon="lucide:check-circle" class="w-4 h-4 text-green-400" />
							{:else}
								<Icon icon="lucide:copy" class="w-4 h-4" />
							{/if}
			...
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					...
					<ul class="space-y-1 ml-4 text-muted-foreground">
						<li>• Use <code>spore deps sync</code> to find and resolve conflicts</li>
					...
					<div class="bg-black/90 text-blue-400 font-mono text-sm rounded-lg relative group mt-3">
						<div class="overflow-x-auto p-4 pr-12">
							<code class="whitespace-nowrap block">spore deps sync</code>
						</div>
						<button 
							class="absolute top-2 right-2 p-2 rounded-md bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover:opacity-100 z-10"
							on:click={() => copyToClipboard('spore deps sync')}
						>
							{#if showCopied && copyText === 'spore deps sync'}
								<Icon icon="lucide:check-circle" class="w-4 h-4 text-green-400" />
							{:else}
								<Icon icon="lucide:copy" class="w-4 h-4" />
							{/if}
			...
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					...
					<ul class="space-y-1 ml-4 text-muted-foreground">
						...
						<li>• Use <code>spore search</code> to find available packages</li>
					</ul>
					<div class="bg-black/90 text-purple-400 font-mono text-sm rounded-lg relative group mt-3">
						<div class="overflow-x-auto p-4 pr-12">
							<code class="whitespace-nowrap block">spore search "package-name"</code>
						</div>
						<button 
							class="absolute top-2 right-2 p-2 rounded-md bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover:opacity-100 z-10"
							on:click={() => copyToClipboard('spore search "package-name"')}
						>
							{#if showCopied && copyText === 'spore search "package-name"'}
								<Icon icon="lucide:check-circle" class="w-4 h-4 text-green-400" />
							{:else}
								<Icon icon="lucide:copy" class="w-4 h-4" />
							{/if}
			...
			<div class="border rounded-lg p-6">
				...
				<div class="space-y-3 text-sm">
					...
					<ul class="space-y-1 ml-4 text-muted-foreground">
						<li>• Run <code>spore link --force</code> to refresh path mappings</li>
						<li>• Check if package has been built with <code>spore run build</code></li>
					...
					<div class="bg-black/90 text-orange-400 font-mono text-sm rounded-lg relative group mt-3">
						<div class="overflow-x-auto p-4 pr-12">
							<code class="whitespace-nowrap block">spore link --force && spore run build</code>
						</div>
						<button 
							class="absolute top-2 right-2 p-2 rounded-md bg-white/10 hover:bg-white/20 transition-colors opacity-0 group-hover:opacity-100 z-10"
							on:click={() => copyToClipboard('spore link --force && spore run build')}
						>
							{#if showCopied && copyText === 'spore link --force && spore run build'}
								<Icon icon="lucide:check-circle" class="w-4 h-4 text-green-400" />
							{:else}
								<Icon icon="lucide:copy" class="w-4 h-4" />
							{/if}
				...
				<div class="flex items-start space-x-3">
					...
					<div>
						...
						<ul class="text-sm text-blue-700 space-y-1">
							<li>• Check the <a href="https://github.com/saravenpi/spore/issues" class="underline">GitHub issues</a></li>
