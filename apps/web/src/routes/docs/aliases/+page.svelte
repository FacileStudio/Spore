...
<svelte:head>
	<title>Package Aliases - Spore CLI Documentation</title>
	<meta name="description" content="Learn how to configure and use package aliases with Spore CLI for cleaner imports and better developer experience." />
...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6">
	...
	<section class="mb-12">
		...
		<p class="text-muted-foreground mb-6">
			The most powerful feature of Spore aliases is the ability to assign custom names to individual packages, making your imports more semantic and maintainable.
		</p>
...
<span class="text-zinc-300">import</span> {"{ "}<span class="text-zinc-100">ProductModel</span> {"} "}<span class="text-zinc-300">from</span> <span class="text-zinc-100">'#models'</span>;</code></pre>
			...
			<div class="border rounded-lg p-6">
				...
				<p class="text-muted-foreground mb-4">
					Spore automatically generates TypeScript path mappings for your aliases.
				</p>
	...
	<section class="mb-12">
		...
		<p class="text-muted-foreground mb-6">
			Spore supports two complementary aliasing systems that work together to provide maximum flexibility.
		</p>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
			<a href="/docs/typescript" class="block border rounded-lg p-6 hover:bg-accent transition-colors">
				...
				<p class="text-sm text-muted-foreground">
					Learn more about TypeScript configuration and best practices with Spore.
				</p>
			</a>
