...
<svelte:head>
	<title>Build Optimization - Spore CLI Documentation</title>
	<meta name="description" content="Optimize your builds for maximum performance and efficiency with Spore's build optimization features." />
</svelte:head>
