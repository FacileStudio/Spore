...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6">
	<div class="mb-8">
		...
		<p class="text-lg text-muted-foreground">
			Comprehensive guide to configuring Spore projects, packages, and applications
		</p>
	</div>
	...
	<section class="mb-12">
		...
		<p class="text-muted-foreground leading-relaxed mb-6">
			Spore uses YAML configuration files to define project structure, dependencies, and build processes. 
	...
	<section class="mb-12">
		<h2 class="text-2xl font-bold mb-6">Project Configuration (spore.yml)</h2>
		
		<div class="space-y-6">
			<p class="text-muted-foreground">
				The root <code>spore.yml</code> file defines your project's global configuration and metadata.
			</p>
				...
				<div class="space-y-4">
					...
					<div class="border rounded-lg p-4">
						...
						<p class="text-sm text-muted-foreground mb-2">
							Global scripts that can be run from any app directory with <code>spore run &lt;script&gt;</code>
						</p>
						<div class="text-sm space-y-1">
							...
							<div>• Can reference other spore commands</div>
						</div>
					</div>
...
<span class="text-blue-400">scripts:</span>
  <span class="text-blue-400">test:</span> <span class="text-green-400">"jest --coverage"</span></code></pre>
	...
	<section class="mb-12">
		...
		<div class="space-y-6">
			<p class="text-muted-foreground">
				Spore provides a powerful variable system that allows you to use dynamic values in your configuration files.
				Variables can be interpolated in any string value across spore.yml, app.yml, and package.yml files.
			</p>

			<div>
				<h3 class="text-lg font-semibold mb-3">Variable Syntax</h3>
				<p class="text-muted-foreground mb-4">
					Spore supports two variable interpolation syntaxes that you can use in your YAML configuration files:
				</p>
					...
					<div class="space-y-3">
						...
						<div class="flex items-center space-x-3">
							...
							<div>
								...
								<div class="text-sm text-muted-foreground">Variables defined in spore.yml</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div>
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div class="border rounded-lg p-4">
						...
						<div class="text-sm space-y-2">
							<div class="flex justify-between">
								...
								<span class="text-muted-foreground">Name from spore.yml</span>
							</div>
							<div class="flex justify-between">
					...
					<div class="border rounded-lg p-4">
						...
						<div class="text-sm space-y-2">
							<div>
								<code class="bg-muted px-2 py-1 rounded">spore vars list</code>
								<div class="text-muted-foreground mt-1">Show all available variables</div>
							</div>
							<div>
								<code class="bg-muted px-2 py-1 rounded">spore vars get &lt;name&gt;</code>
  ...
  <span class="text-blue-400">version:</span> <span class="text-green-400">"${BUILD_VERSION}"</span>     <span class="text-gray-400"># Falls back to $BUILD_VERSION env var</span></code></pre>
					...
					<div class="border rounded-lg p-4">
						...
						<div class="text-sm space-y-2 text-muted-foreground">
							<div>• <strong>Undefined variables:</strong> Spore will show an error with suggestions of available variables</div>
	...
	<section class="mb-12">
		...
		<div class="space-y-6">
			<p class="text-muted-foreground">
				Spore supports environment-specific configurations and can load environment variables.
			</p>
			...
			<div>
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div class="border rounded-lg p-4">
						<h4 class="font-semibold mb-2">Spore Environment Variables</h4>
						<div class="text-sm space-y-1">
							<div><code class="bg-muted px-2 py-1 rounded">SPORE_TOKEN</code> - Authentication token</div>
							<div><code class="bg-muted px-2 py-1 rounded">SPORE_SPACE_URL</code> - Registry URL</div>
							<div><code class="bg-muted px-2 py-1 rounded">SPORE_ENV</code> - Environment (dev/prod)</div>
						</div>
					</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
			...
			<div class="space-y-6">
				...
				<div class="border rounded-lg p-6">
					...
					<ul class="text-sm text-muted-foreground space-y-2">
						<li>• Spore validates YAML syntax automatically</li>
	...
	<section class="mb-12">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
			<a href="/docs/package-linking" class="block border rounded-lg p-6 hover:bg-accent transition-colors">
				...
				<p class="text-sm text-muted-foreground">
					Learn how Spore links packages and manages dependencies between apps and packages.
				</p>
			</a>
			...
			<a href="/docs/project-management" class="block border rounded-lg p-6 hover:bg-accent transition-colors">
				...
				<p class="text-sm text-muted-foreground">
					Explore all available Spore CLI commands and their usage patterns.
				</p>
			</a>
		</div>
	</section>
