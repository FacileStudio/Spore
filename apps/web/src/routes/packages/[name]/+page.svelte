...
<svelte:head>
	{#if selectedPackage}
		...
		<link rel="canonical" href="https://spore.klysium.com/packages/{encodeURIComponent(selectedPackage.name)}" />
		...
		<script type="application/ld+json">
		{
			...
			"url": "https://spore.klysium.com/packages/{encodeURIComponent(selectedPackage.name)}",
			"author": {
				"@type": "Person",
			...
			"downloadUrl": "https://spore.klysium.com/packages/{encodeURIComponent(selectedPackage.name)}",
				...
				"itemListElement": [
					{
						...
						"position": 1,
						"name": "Home",
						"item": "https://spore.klysium.com"
					},
					{
						"@type": "ListItem",
						"position": 2,
						"name": "Packages",
						"item": "https://spore.klysium.com/packages"
					},
					{
						"@type": "ListItem",
						"position": 3,
						"name": "{selectedPackage.name}",
						"item": "https://spore.klysium.com/packages/{encodeURIComponent(selectedPackage.name)}"
					}
				]
			}
		}
		...
		<div class="space-y-4">
			...
			<div class="bg-muted rounded-lg p-4">
				<div class="flex items-center justify-between mb-2">
					<span class="text-sm font-medium">Spore CLI</span>
					<button 
						on:click={async () => {
							await navigator.clipboard.writeText(`spore install @${selectedPackage.name}@${selectedPackage.version}`);
							copySuccess = true;
				...
				<code class="text-sm">spore install @{selectedPackage.name}@{selectedPackage.version}</code>
			</div>
		</div>
