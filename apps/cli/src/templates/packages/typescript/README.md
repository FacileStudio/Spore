...
This is a TypeScript package template that demonstrates how to create packages that work seamlessly with Spore's alias system.
...
├── package.yml           # Spore package configuration
...
```json
{
  "compilerOptions": {
    "paths": {
      "@ui/*": ["./spore_packages/*"],  // If tsAlias is "@ui"
      "#/*": ["./spore_packages/*"],    // If tsAlias is "#"  
      "$/*": ["./spore_packages/*"]     // If tsAlias is "$"
    }
  },
  "include": [
    "src/**/*",
    "spore_packages/**/*"  // Include linked packages
  ]
}
```
