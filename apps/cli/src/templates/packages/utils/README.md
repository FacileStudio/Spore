...
A foundational utility package providing common functions, types, and helpers that other packages in your Spore project can depend on. This package serves as the base layer in the dependency hierarchy.
