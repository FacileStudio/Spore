...
"#;
        ...
        assert_eq!(result.name, "spore-test");
        assert_eq!(result.version, Some("1.0.0".to_string()));
        assert_eq!(result.description, Some("Test config for spore-test".to_string()));
    }
...
"#;
        ...
        assert!(result.contains("spore-test"));
