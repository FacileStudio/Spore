...
This directory contains comprehensive examples demonstrating the YAML variable interpolation system for the Spore project.
...
- **`spore_config_example.yml`** - Complete spore.yml with variables
...
5. **Integration** - Real Spore configurations work with interpolation
...
- **Compatible** - Works with existing Spore configuration formats
